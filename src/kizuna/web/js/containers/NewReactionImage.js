...
...
  ...
  autocompleteRenderInput({alreadyUsedTags}, {addTag,
}
...
>
  ...
  const theme = {
    ...
    suggestion
:
  'react-tagsinput-tag react-autosuggest__suggestion'
}
  ;
...
<
  ...
  style = {
  {
    height: images.length > 10 ? '100px' : '150px'
  }
}
  />
})
...
<
form
onSubmit = {this.uploadImages.bind(this)
}>
<
Sticky
enabled = {true} >
...
<
  ...
  style = {rowStyle} >
    {image.uploaded && < strong > Uploaded
  successfully < /strong>}
  {
    image.uploadFailure && < strong
    style = {
    {
      color: 'red'
    }
...
<
button
className = "pure-button" > browse < /button>
or
drag
images
here.
